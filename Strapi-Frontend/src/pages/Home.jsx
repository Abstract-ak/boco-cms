  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        ...
        const response = await fetch("https://boco-cms-backend.onrender.com/api/services");
      ...
      <section className="h-screen flex items-center justify-center bg-black text-white px-4">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            We Design & Build
            <span className="text-blue-500"> Strategic</span> Digital
            Experiences
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300">
            As Shopify Partners and a leading eCommerce Web Design Agency, we
            empower brands to thrive through strategic design and robust
            development.
          </p>
          <Link
            to="/contact"
